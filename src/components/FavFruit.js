...
class FavFruit extends React.Component {
  ...
  handleUpdate = async (e) => {
    let id = this.state.favFruitData[this.state.index]._id;
    let email = this.props.auth0.user.email;
    let data = {
  ...
  render() {
    return (
      <>
        ...
        <Container>
          <Row>
            {this.state.favFruitData.length > 0 &&
              this.state.favFruitData.map((element, index) => {
                return (
                  <Col>
              ...
              >
                ...
                >
                  ...
                  <Form.Control
                    type="text"
                    name="name"
                    Value={this.state.infoModal.name}
                  />
                  ...
                  <Form.Control
                    type="text"
                    name="price"
                    Value={this.state.infoModal.price}
                  />
                  ...
                  <Form.Control
                    type="text"
                    name="image"
                    Value={this.state.infoModal.image}
                  />
